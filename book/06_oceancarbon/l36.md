...
where 12 is the atomic mass of carbon. For a pCO<sub>2</sub> of 400 ppm with $n_{air}$ of 1.773x10<sup>20</sup>, this yields a total mass of ~850 GtC in out model atmosphere.
...
In practicals, you will use a [python package](https://github.com/oscarbranson/cbsyst) to do these calculations.
...
$
\mathrm{TA = 2[CO_3^{2-}] + [HCO_3^-] + [B(OH)_4^-] + [minor~bases] + [OH^-] - [H^+]}
$
