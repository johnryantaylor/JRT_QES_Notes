...
We can model DIC as a conservative tracer {eq}`eq:3box:conservative`, with additional terms for the exchange of CO<sub>2</sub> with the atmosphere.

```{math}
:label: eq:carbon:model
```
