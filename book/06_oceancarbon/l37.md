...
```{math}
:label: eq:carbon:PO4
\dv{P_L}{t} &= \left( \text{[...]} - \frac{V_L}{\tau^P_L} P_L \right) / V_L \\
\dv{P_H}{t} &= \left( \text{[...]} - \frac{V_L}{\tau^P_H} P_H \right) / V_H \\
\dv{P_D}{t} &= \left( \text{[...]} + \frac{V_L}{\tau^P_L} P_L + \frac{V_L}{\tau^P_H} P_H \right) / V_D
```

Where $\text{[...]}$ represents the conservative transport terms in {eq}`eq:3box:conservative`.
...
```{math}
:label: eq:carbon:dic:biopump
\dv{DIC_L}{t} &= \left( \text{[...]} - 106 \frac{V_L}{\tau^P_L} P_L \right) / V_L \\
\dv{DIC_H}{t} &= \left( \text{[...]} - 106 \frac{V_L}{\tau^P_H} P_H \right) / V_H \\
\dv{DIC_D}{t} &= \left( \text{[...]} + 106 \frac{V_L}{\tau^P_L} P_L + 106 \frac{V_L}{\tau^P_H} P_H \right) / V_D
```
