...
\begin{frame}{Ocean Structure}
    ...
    \includegraphics<2>[width=\linewidth, totalheight=0.8\textheight, keepaspectratio]{carbon_components.png}
...
\begin{frame}{3-Box Model}
    \begin{columns}
        \begin{column}{0.6\linewidth}
            \includegraphics[width=\linewidth, totalheight=0.8\textheight, keepaspectratio]{Ocean_3box.png}
        \end{column}   
