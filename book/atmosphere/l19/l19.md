...
**Figure 1.4** Temperature profile for stable conditions
...
In panel (b) of Figure 1.5 we can see that different molecules absorb the different wavelengths of radiation emitted by the sun and Earth.
